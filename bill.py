...
class Bill_App:
    def __init__(self,root):
        ...
        cphn_lbl=Label(F1,text="Phone Number No.",bg=bg_color,fg="white",font=("times new roman",15,"bold")).grid(row=0,column=2,padx=20,pady=5)
        ...
        bath_lbl=Label(F2,text="Soap",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,sticky="w")
        ...
        Fce_w_txt=Entry(F2,width=10,textvariable=self.face_wash,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=10 )
        ...
        g4_s_lbl=Label(F3,text="wheat",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=3,column=0,padx=10,sticky="w")
        ...
        g5_g_lbl=Label(F3,text="Sugar",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=4,column=0,padx=10,sticky="w")
        ...
        #===========Cold Drink Frame================
        F4=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cold Drink`",font=("times new roman",15,"bold"),fg="red",bg=bg_color)
        F4.place(x=670,y=180,width=325,height=380)
        
        c1_lbl=Label(F4,text="Maza",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,sticky="w")
        ...
        c2_cream_lbl=Label(F4,text="Cock",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=1,column=0,padx=10,sticky="w")
        ...
        F6=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cosmetics",font=("times new roman",15,"bold"),fg="red",bg=bg_color)
        ...
        GBill_btn=Button(btn_F,text="Genrate Bill",command=self.bill_area,bg="cadetblue",fg="white",bd=2,pady=15,width=11,font="arial 12 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",bg="cadetblue",fg="white",bd=2,pady=15,width=11,font="arial 12 bold").grid(row=0,column=2,padx=5,pady=5)
        Exite_btn=Button(btn_F,text="Exit",bg="cadetblue",fg="white",bd=2,pady=15,width=11,font="arial 12 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    ...
    def bill_area(self):   
        if self.c_name.get()=="" or self.c_phon.get()=="":
           ...
           messagebox.showerror("NO Product puchased")   
        else:   
          self.welcome_bill()      
        #======Cosmetics=====
        if self.soap.get()!=0:
        ...
        if self.cock.get()!=0:
             self.txtarea.insert(END,f"\n Cock \t\t{self.face_cream.get()}\t\t{self.d_c_p}")          
        if self.frooti.get()!=0:
             self.txtarea.insert(END,f"\n Frooti \t\t{self.face_wash.get()}\t\t{self.d_f_p}")      
        if self.thumbsup.get()!=0:
             self.txtarea.insert(END,f"\n Thumbsup \t\t{self.spray.get()}\t\t{self.d_t_p}")         
        if self.limca.get()!=0:
